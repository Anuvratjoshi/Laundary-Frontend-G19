...
function OrderContent() {
    ...
    useEffect(() => {
        fetch("https://laundry-cart-backend-g19.onrender.com/getorder", {
            method: "GET",
            headers: {
    ...
    const deleteItem = (id) => {
        fetch("https://laundry-cart-backend-g19.onrender.com/deleteorder", {
            method: "delete",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("jwt"),
                "Content-Type": "application/json"
    ...
    const findServiceArray = (id) => {
        fetch("https://laundry-cart-backend-g19.onrender.com/findorder", {
            method: "POST",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("jwt"),
                "Content-Type": "application/json"
